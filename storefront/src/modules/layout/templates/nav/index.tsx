...
export default async function Nav() {
  ...
  return (
    <div className="sticky top-0 inset-x-0 z-50 group bg-opacity-90 backdrop-blur-md">
      <header className="relative h-16 mx-auto border-b duration-200 bg-white border-ui-border-base shadow-md">
